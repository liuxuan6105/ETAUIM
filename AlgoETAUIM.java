...
//	int sfupCount =0;  // the number of SFUP generated
	...
	//	System.out.println(minutil);
		...
		try {
			...
			while ((thisLine = myInput.readLine()) != null) {
                ...
                int rmau = 0, rn=0;double rtaub;int max=Integer.MIN_VALUE; int smax=Integer.MIN_VALUE;
	 ...
	 * @throws IOException
	 */
	private void Search(List<UtilityList> prefixULs, List<UtilityList> exULs)
			throws IOException {		
		scan(exULs);
		ULs uls = new ULs();
	...
	public void printStats() {
		System.out.println("=============  myBreadth1a v 2.11 - STATS =============");
